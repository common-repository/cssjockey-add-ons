...
class CMB2_JS {
	...
	protected static function colorpicker_frontend() {
		...
		wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
			'clear'         => esc_html__( 'Clear', 'wp-builder-locale' ),
			'defaultString' => esc_html__( 'Default', 'wp-builder-locale' ),
			'pick'          => esc_html__( 'Select Color', 'wp-builder-locale' ),
			'current'       => esc_html__( 'Current Color', 'wp-builder-locale' ),
		) );
	}
		...
		$l10n = array(
			...
			'defaults'          => array(
				...
				'date_picker'  => array(
					'changeMonth'     => true,
					'changeYear'      => true,
					'dateFormat'      => _x( 'mm/dd/yy', 'Valid formatDate string for jquery-ui datepicker', 'wp-builder-locale' ),
					'dayNames'        => explode( ',', esc_html__( 'Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday', 'wp-builder-locale' ) ),
					'dayNamesMin'     => explode( ',', esc_html__( 'Su, Mo, Tu, We, Th, Fr, Sa', 'wp-builder-locale' ) ),
					'dayNamesShort'   => explode( ',', esc_html__( 'Sun, Mon, Tue, Wed, Thu, Fri, Sat', 'wp-builder-locale' ) ),
					'monthNames'      => explode( ',', esc_html__( 'January, February, March, April, May, June, July, August, September, October, November, December', 'wp-builder-locale' ) ),
					'monthNamesShort' => explode( ',', esc_html__( 'Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Dec', 'wp-builder-locale' ) ),
					'nextText'        => esc_html__( 'Next', 'wp-builder-locale' ),
					'prevText'        => esc_html__( 'Prev', 'wp-builder-locale' ),
					'currentText'     => esc_html__( 'Today', 'wp-builder-locale' ),
					'closeText'       => esc_html__( 'Done', 'wp-builder-locale' ),
					'clearText'       => esc_html__( 'Clear', 'wp-builder-locale' ),
				),
				'time_picker'  => array(
					'timeOnlyTitle' => esc_html__( 'Choose Time', 'wp-builder-locale' ),
					'timeText'      => esc_html__( 'Time', 'wp-builder-locale' ),
					'hourText'      => esc_html__( 'Hour', 'wp-builder-locale' ),
					'minuteText'    => esc_html__( 'Minute', 'wp-builder-locale' ),
					'secondText'    => esc_html__( 'Second', 'wp-builder-locale' ),
					'currentText'   => esc_html__( 'Now', 'wp-builder-locale' ),
					'closeText'     => esc_html__( 'Done', 'wp-builder-locale' ),
					'timeFormat'    => _x( 'hh:mm TT', 'Valid formatting string, as per http://trentrichardson.com/examples/timepicker/', 'wp-builder-locale' ),
					'controlType'   => 'select',
					'stepMinute'    => 5,
				),
			),
			'strings' => array(
				'upload_file'  => esc_html__( 'Use this file', 'wp-builder-locale' ),
				'upload_files' => esc_html__( 'Use these files', 'wp-builder-locale' ),
				'remove_image' => esc_html__( 'Remove Image', 'wp-builder-locale' ),
				'remove_file'  => esc_html__( 'Remove', 'wp-builder-locale' ),
				'file'         => esc_html__( 'File:', 'wp-builder-locale' ),
				'download'     => esc_html__( 'Download', 'wp-builder-locale' ),
				'check_toggle' => esc_html__( 'Select / Deselect All', 'wp-builder-locale' ),
			),
		);
