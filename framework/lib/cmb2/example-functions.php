...
function yourprefix_register_demo_metabox() {
	...
	$cmb_demo = new_cmb2_box( array(
		'id'            => $prefix . 'metabox',
		'title'         => esc_html__( 'Test Metabox', 'wp-builder-locale' ),
	...
	$cmb_demo->add_field( array(
		'name'       => esc_html__( 'Test Text', 'wp-builder-locale' ),
		'desc'       => esc_html__( 'field description (optional)', 'wp-builder-locale' ),
		'id'         => $prefix . 'text',
		'type'       => 'text',
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Text Small', 'wp-builder-locale' ),
		'desc' => esc_html__( 'field description (optional)', 'wp-builder-locale' ),
		'id'   => $prefix . 'textsmall',
		'type' => 'text_small',
		// 'repeatable' => true,
		// 'column' => array(
		// 	'name'     => esc_html__( 'Column Title', 'wp-builder-locale' ), // Set the admin column title
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Text Medium', 'wp-builder-locale' ),
		'desc' => esc_html__( 'field description (optional)', 'wp-builder-locale' ),
	...
	$cmb_demo->add_field( array(
		'name'       => esc_html__( 'Read-only Disabled Field', 'wp-builder-locale' ),
