...
if( isset( $_POST['submit-step-form'] ) ) {
	...
	set_transient( 'cjwpbldr_install_theme_step', 7, 84600 );
	wp_redirect( $this->helpers->callbackUrl( 'core-install-themes' ) );
	die();
}

$this->helpers->enableFrameworkFeature( 'testimonials' );
$team_members = $this->helpers->getPosts( [
	'post_type' => 'wpb-testimonials',
	'posts_per_page' => 10,
	'post_status' => 'publish',
] );
...
<div class="cj-box cj-br-0 cj-m-0 cj-pv-10 cj-bg-light">
    <p>In this step we will create a few testimonials similar to the demo site.</p>
</div>
        ...
        <div class="cj-level">
            <div class="cj-level-left">
                <div class="cj-level-item">
                    <button name="submit-step-form" type="submit" class="cj-button cj-is-primary">Create Testimonials</button>
                </div>
                <div class="cj-level-item">
